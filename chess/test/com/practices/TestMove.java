...
public class TestMove {
	...
	public void movePawn() {
		...
		assertEquals(Pawn.createWhitePawn(), whitePawn);
	...
	public void moveKnight() {
		...
		assertEquals(Knight.createWhiteKnight(), whiteKnight);
		assertEquals(Blank.create(), blank);
	}
	...
	public void moveRook() {
		...
		assertEquals(Rook.createWhiteRook(), whiteRook);
		assertEquals(Blank.create(), blank);
	}
	...
	public void moveBishop() {
		...
		assertEquals(Bishop.createWhiteBishop(), whiteBishop);
		assertEquals(Blank.create(), blank);
		board.move("f1", "f6");
		Piece blank2 = board.findPiece("f1");
		Piece whiteBishop2 = board.findPiece("f6");
		assertEquals(Bishop.createWhiteBishop(), whiteBishop2);
	...
	public void moveQueen() {
		...
		assertEquals(Queen.createWhiteQueen(), whiteQueen);
		assertEquals(Blank.create(), blank);
	}
	...
	public void moveKing() {
		...
		assertEquals(King.createWhiteKing(), whiteKing);
		assertEquals(Blank.create(), blank);
	}
}
